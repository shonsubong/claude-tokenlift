...
description: >-
  ...
  모델로는 부족하지만 Bedrock 토큰은 아끼고 싶은 작업을, 온프렘 H200 클러스터의 프런티어
  오픈모델(예: DeepSeek-R1, Qwen3-Coder-480B)로 위임하는 "Oracle" 서브에이전트. oh-my-openagent
...
```bash
tokenlift warmup --provider onprem-h200 -m deepseek-ai/DeepSeek-R1
